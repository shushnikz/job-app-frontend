...
export const getAllJobs = () => async dispatch => {
    ...
    try {
        const response = await axios.get("https://find-job-app-backend.herokuapp.com/api/jobs/getalljobs")
...
export const postJobs = (values) => async dispatch => {
    ...
    dispatch({ type: 'LOADING', payload: true })
    try {
        const response = await axios.post("https://find-job-app-backend.herokuapp.com/api/jobs/postjob", values)
...
export const editJobs = (values) => async dispatch => {
    ...
    dispatch({ type: 'LOADING', payload: true })
    try {
        const response = await axios.post("https://find-job-app-backend.herokuapp.com/api/jobs/editjob", values)
...
export const applyJobs = (job) => async dispatch => {
    ...
    dispatch({ type: 'LOADING', payload: true })
    try {
        const response = await axios.post("https://find-job-app-backend.herokuapp.com/api/jobs/applyjob", { job, user })
